...
migrateup:
	migrate -path db/migration -database "postgresql://root:waRnS6HKWqCGEPgHlX4N@simple-bank.cz0ksokkg1cr.ap-southeast-1.rds.amazonaws.com:5432/simple_bank" -verbose up
