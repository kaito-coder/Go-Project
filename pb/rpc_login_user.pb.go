...
func (x *LoginUserReponse) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *LoginUserReponse) GetAccessToken() string {
	if x != nil {
...
func (x *LoginUserReponse) GetRefreshToken() string {
	if x != nil {
...
func (x *LoginUserReponse) GetAccessTokenExpiresAt() *timestamp.Timestamp {
	if x != nil {
...
func (x *LoginUserReponse) GetRefreshTokenExpiresAt() *timestamp.Timestamp {
	if x != nil {
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1c, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72,
	...
	0x72, 0x65, 0x73, 0x41, 0x74, 0x42, 0x10, 0x5a, 0x0e, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2d,
...
var file_rpc_login_user_proto_depIdxs = []int32{
	...
	3, // 1: pb.LoginUserReponse.access_token_expires_at:type_name -> google.protobuf.Timestamp
	3, // 2: pb.LoginUserReponse.refresh_token_expires_at:type_name -> google.protobuf.Timestamp
